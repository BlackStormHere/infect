...
'
echo " " 
echo -e "$red                       ▶Coded by$grn BS$red◀$rset"
echo -e "$red                      ⫸$ylo  BLACKSTORM$red ⫷$rset"
echo 
# Functions
...
then
am start -a android.intent.action.VIEW -d https://youtube.com/@BlackStormHere > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
am start -a android.intent.action.VIEW -d https://github.com/BlackStormHere > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
am start -a android.intent.action.VIEW -d https://chat.whatsapp.com/Bb83IUnEDtQ7861LSmj2Ii > /dev/null 2>&1
banner
menu
elif [ $optnz = "8" ];
then
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m               CALL ME \e[92mBLACKSTORMHERE"  | pv  -qL 10
echo -e "\e[93m             IAM FROM \e[92mBLACKSTORM" | pv -qL 10
